...
var eating_sound;
var star1,star2
var star1Img, star2Img;
var emptystar,emptystarImg;
var oneStarImg, secStar;
...
function setup() 
{
  ...
  star1 = createSprite(220,50);
  star1.addImage(star1Img);
  star1.scale = 0.02;

  star2 = createSprite(50,320);
  star2.addImage(star2Img);
  star2.scale = 0.02;

  emptystar = createSprite(65,25);
  emptystar.addImage(emptystarImg);
  emptystar.scale = 0.2
...
function draw() 
{
  ...
  if(fruit!=null && fruit.position.y>=650)
  {
   ...
   if(collide(fruit,star1)=== true){
     star1.visible = false;
     emptystar.addImage(oneStarImg);
     emptystar.changeImage(oneStarImg);
   }

   if(collide(fruit, star2) === true){
     star2.visible = false;
     secStar = createSprite(90,25)
     secStar.addImage(star1Img);
     secStar.scale = 0.019;
   }
